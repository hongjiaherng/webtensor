// Strided ReduceSum. One invocation per output element.
// Serial inner loop over the reduce-axis Cartesian product. Good enough for v1;
// a hierarchical workgroup-local reduction is a later optimization.
