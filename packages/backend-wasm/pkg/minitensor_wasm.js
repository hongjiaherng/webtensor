 ...
 * @param {number} len
 */
export function add_raw(a_ptr, b_ptr, out_ptr, len) {
    wasm.add_raw(a_ptr, b_ptr, out_ptr, len);
}
 ...
 * @param {number} len
 */
export function div_raw(a_ptr, b_ptr, out_ptr, len) {
    wasm.div_raw(a_ptr, b_ptr, out_ptr, len);
}
 ...
 * @param {number} len
 */
export function mul_raw(a_ptr, b_ptr, out_ptr, len) {
    wasm.mul_raw(a_ptr, b_ptr, out_ptr, len);
}
 ...
 * @param {number} len
 */
export function sub_raw(a_ptr, b_ptr, out_ptr, len) {
    wasm.sub_raw(a_ptr, b_ptr, out_ptr, len);
}
