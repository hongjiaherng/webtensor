...
export interface InitOutput {
    ...
    readonly add_raw: (a: number, b: number, c: number, d: number) => void;
    readonly alloc_f32: (a: number) => number;
    readonly div: (a: number, b: number, c: number, d: number, e: number, f: number, g: any) => void;
    readonly div_raw: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly mul_raw: (a: number, b: number, c: number, d: number) => void;
    readonly sub: (a: number, b: number, c: number, d: number, e: number, f: number, g: any) => void;
    readonly sub_raw: (a: number, b: number, c: number, d: number) => void;
