...
export const add_raw: (a: number, b: number, c: number, d: number) => void;
export const alloc_f32: (a: number) => number;
export const div: (a: number, b: number, c: number, d: number, e: number, f: number, g: any) => void;
export const div_raw: (a: number, b: number, c: number, d: number) => void;
...
export const mul_raw: (a: number, b: number, c: number, d: number) => void;
export const sub: (a: number, b: number, c: number, d: number, e: number, f: number, g: any) => void;
export const sub_raw: (a: number, b: number, c: number, d: number) => void;
