...
**Where:** [packages/core/src/ops/elementwise/abs.ts](https://github.com/hongjiaherng/webtensor/blob/main/packages/core/src/ops/elementwise/abs.ts) — search for `// NOTE: abs backward requires sign(a)`.
