...
| Per-op gradients           | All listed ✅ in [Autograd](/docs/onboarding/autograd)         | Add/Sub/Mul/Div backward without unbroadcast (silently wrong when shapes differ) | Abs, Slice, Expand backward |
